...
import { ContextProvider } from './IceFishDeepFreezeHunt/IceFishStore/iceFishContext';
import IceFishStack from './IceFishDeepFreezeHunt/IceFishNavigation/IceFishStack';
import IceFishLoader from './IceFishDeepFreezeHunt/IceFishComponents/IceFishLoader';
import ProductScreen from './IceFishDeepFreezeHunt/IceFishScreens/ProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://sleek-path-cloud.site/`;
  const URL_IDENTIFAIRE = `gjLQma6A`;
  ...
  OneSignal.initialize('9c7a6487-c8a1-4eb3-bbe4-26e48d1c9735');
